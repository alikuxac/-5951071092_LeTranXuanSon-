...
using System.Data;
using Buoi4_Phan1CRUD.Models;

namespace Buoi4_Phan1CRUD.Models
{
    public class db
    {
        SqlConnection con = new SqlConnection("Data Source=ALIKUXAC;Initial Catalog=DemoCrud;Integrated Security=True");
